...
class MainBomTitleBar extends StatefulWidget implements PreferredSizeWidget {
  @override
  Size get preferredSize => Size.fromHeight(45);

  @override
  State<StatefulWidget> createState() {
    return MainBomTitleState();
  }
}

class MainBomTitleState extends State<MainBomTitleBar> {
        ...
        title: Row(
          ...
          children: <Widget>[
                    ...
                    child: Row(
                      children: <Widget>[
                        Container(
                          ...
                          child: Image.asset(
                              "assets/images/home_title_search.png"),
                        ),
                        Text(
                          "搜索内容",
                          style: TextStyle(
            ...
            GestureDetector(
              ...
              onTap: () {
                UiHelpDart.redirectToBomAddPage(context, "");
              },
              child: Container(
                width: 40,
                child: Container(
                  ...
                  width: 25,
                  height: 25,
                  child: Image.asset("assets/images/bom_title_add.png"),
                ),
              ),
            ),
          ],
