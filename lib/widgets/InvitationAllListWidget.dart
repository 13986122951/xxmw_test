...
class InvitationAllListWidget extends StatefulWidget {
  InvitationAllListWidget(String id) {
    topicId = id;
  }
...
getTopicPostsPage() {
  ReqQuoteApi.getInstance().getTopicPostsPage(
      new InfoCallBack(), pkid, recordNum, pageSize, postType);
}

class InvitationListState extends State<InvitationAllListWidget>
