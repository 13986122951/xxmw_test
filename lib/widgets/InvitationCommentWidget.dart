...
class InvitationCommentWidget extends StatefulWidget {
  InvitationCommentWidget(String id) {
    commentId = id;
  }
...
refPostsReply() {
  ReqQuoteApi.getInstance()
      .getPostsReply(new InfoCallBack(), commentId, startNum, pageSize, "1");
}

EasyRefreshController _controller = EasyRefreshController();

class InvitationCommentState extends State<InvitationCommentWidget>
